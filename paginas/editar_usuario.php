                ...
                ?>
                    <form action="adm_usuario.php" method="post">
                        ...
                        <select class="form-control" id="rol" name="rol">
                            ...
                            <?php
                            $array = array(
                                ['rol' => 'adm', 'name' => 'Administrador'],
                                ['rol' => 'asi', 'name' => 'Asistente'],
                                ['rol' => 'doc', 'name' => 'Doctor'],
                                ['rol' => 'fis', 'name' => 'Fisioterapeuta']
                            );
                            foreach ($array as $object) {
                                if ($object['rol'] === $row['rol']) {
                                    echo "<option value='{$object['rol']}' selected>{$object['name']}</option>";
                                } else {
                                    echo "<option value='{$object['rol']}'>{$object['name']}</option>";
                                }
                            }
                            ?>
                        </select><br>
