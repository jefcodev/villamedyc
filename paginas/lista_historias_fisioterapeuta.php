        ...
        <div class="row">
            <div class="col-md-12"><br><br>
                ...
                <table class="table table-bordered table-hover" id="indexhistoriah">
                    ...
                    <tbody>
                        <?php
                        $sql_citas = "SELECT cf.consulta_fisio_id, cf.numero_historia, cf.estado_atencion, pc.titulo_paquete, pc.numero_sesiones, pc.total, p.numero_identidad, CONCAT(p.nombres, ' ', p.apellidos) as nombres 
