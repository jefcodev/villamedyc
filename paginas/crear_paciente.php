    ...
    <section class="cuerpo">
        ...
        <form action="adm_paciente.php" method="post" onsubmit="return validar()">
            <div class="row">
                ...
                <div class="col-md-4">
                    <input class="form-control" title="Institución" placeholder="Institución" id="institucion" name="institucion" />
                    <input class="form-control" title="Ocupación" placeholder="Puesto de trabajo" id="ocupacion" name="ocupacion" />
                    <textarea class="form-control" placeholder="Descripción" name="descripcion" id="descripcion" cols="30" rows="2"></textarea>
                    <select class="form-control" title="Tipo de Contingencia" id="tipo_contingencia" name="tipo_contingencia">
                        <option value="" selected="" hidden="">Seleccione Tipo de Contingencia</option>
