...
$id_receta_fis = $_GET['id_receta_fis'];
...
$consulta_fis = "SELECT * FROM consulta_receta_fisio WHERE id_receta='$id_receta_fis' ";
$resultado_fis = $mysqli->query($consulta_fis);
$row_fis = $resultado_fis->fetch_assoc();
...
$pdf->Cell(95, 6, utf8_decode('N° VM-003-') . $id_receta, 0, 0, 'C', 1);
$pdf->Cell(95, 6, utf8_decode('N° VM-003-') . $id_receta, 0, 0, 'C', 1);
$pdf->Ln(10);
...
$pdf->SetX(10);
$pdf->Cell($columnWidth, 6, 'Receta:', 0, 0, 'C', 1);
$pdf->Cell($columnWidth, 6, 'Indicaciones:', 0, 0, 'C', 1);
$pdf->Ln(10);
// Segunda columna para Receta
$pdf->SetX(10);
$pdf->MultiCell($columnWidth, 6, utf8_decode($row['receta']), 0, 'L', 0);

// Segunda columna para Indicaciones
$pdf->SetXY(105,98);
$pdf->MultiCell($columnWidth, 6, utf8_decode($row['indicaciones']), 0, 'L', 0);
...
$pdf->Ln(10);
$pdf->SetFont('Times', 'B', 12);
$pdf->Cell(95, 6, utf8_decode('N° VM-004-') . $id_receta_fis, 0, 0, 'C', 1);
$pdf->Cell(95, 6, utf8_decode('N° VM-004-') . $id_receta_fis, 0, 0, 'C', 1);
$pdf->Ln(10);
...
// Segunda columna para Receta
$pdf->SetX(10);
$pdf->MultiCell($columnWidth, 6, utf8_decode($row_fis['examenes']), 0, 'L', 0);

// Segunda columna para Indicaciones
$pdf->SetXY(105,98);
$pdf->MultiCell($columnWidth, 6, utf8_decode($row_fis['tratamiento']), 0, 'L', 0);
